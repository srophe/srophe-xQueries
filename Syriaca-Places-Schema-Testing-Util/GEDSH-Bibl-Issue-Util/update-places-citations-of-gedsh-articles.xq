...
let $collectionUri := "C:\Users\anoni\Documents\GitHub\srophe\srophe-app-data\data\places\tei\"
for $doc in fn:collection($collectionUri)
  where $doc//listPlace/place/bibl[title[@level="a"]]/ptr[@target="http://syriaca.org/bibl/1"]
  let $footnote := $doc//listPlace/place/bibl[title[@level="a"]]/ptr[@target="http://syriaca.org/bibl/1"]/..
  ...
  return replace node $doc//listPlace/place/bibl[@xml:id = $footnoteId]/ptr with <ptr target="{$newBiblUri}"/>